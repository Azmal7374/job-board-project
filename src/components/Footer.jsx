...
const Footer = () => {
    return (
        ...
        <hr className=" w-96 border-white  cursor-pointer " />
         ...
         <p className="font-bold text-xl mt-1">info@jobboard.com</p>
         </div>
         <div className='mt-6'>
         <p>SOCIALS NETWORK
         </p>
        ...
        <hr className=" w-96 border-white  cursor-pointer " />
         ...
         <Link to='/jobs' className="link no-underline hover:text-orange-400  mt-3 md:mt-6">Jobs</Link> 
         <Link to='/careerAdvice' className="link   mt-3 no-underline hover:text-orange-400">Career</Link> 
         </div>
         <div className='flex flex-col mt-3  ' style={{fontSize:'16px'}}>
         <Link to='/resume' className="link   hover:text-orange-400 no-underline">Order a Resume</Link>
         <Link to='/sector' className="link   mt-3 hover:text-orange-400 no-underline">Sectors</Link>
         </div>
         </div>
      ...
      <div>
      <p className="text-white">Copyright © 2023 Job Board. All rights reserved.</p>
    </div>
