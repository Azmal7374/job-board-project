  ...
  const {logIn, resetPassword} = useContext(AuthContext);
    ...
    return (
     ...
     <img className='w-32 md:w-64 lg:w-96' src={vector1} alt="" />
        <h1 className="mx-auto text-center text-2xl font-bold">Login Here</h1>
...
<button onClick={handleGithubLogin} className='border p-3 rounded-md'><img className='w-10' src={github} alt="" /></button>
</div> 

</div>
    <div className="my-container text-center my-auto">
    <h1 className='text-3xl text-white font-bold'>Job Board</h1>
   ...
   <Link to='/signup'> <button  className="mt-4 shadow  bg-orange-600 hover:bg-orange-700 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded">Sign Up</button></Link>
   </div>
    </div>
    </div>
     </div>
